...
export default async function LoginPage(props: {
  ...
  return (
    <div className="flex-1 flex flex-col w-full px-8 sm:max-w-md justify-center gap-2 mt-24 mx-auto relative z-10">
      ...
      <form className="flex-1 flex flex-col w-full justify-center gap-2 glass-panel p-8 rounded-3xl shadow-2xl border border-white/10" action={login}>
        ...
        <div className="flex flex-col gap-4 mb-6">
          <button type="button" className="flex items-center justify-center gap-3 glass bg-surface-container hover:bg-surface-container-high px-4 py-3 rounded-xl border border-white/5 transition-all duration-300">
        ...
        <button className="bg-primary text-on-primary rounded-xl px-4 py-3 font-bold transition-all duration-300 hover:shadow-[0_0_20px_rgba(173,198,255,0.4)]">
          Send Magic Link
        </button>
